    ...
    <div id="container">
      <div className="form-box">
        <div className='form'>
          ...
          <fieldset>
            <label class="form-label" for="relation">Apartment Number<span class="form-required"> *</span></label>
            <input id="relation" class="form-input" type="text" name="your-relation" placeholder="Enter Apartment Number" required/>
          </fieldset>

          <fieldset>
            <label class="form-label" for="relation">DL<span class="form-required"> *</span></label>
            <input id="relation" class="form-input" type="text" name="your-relation" placeholder="Enter DL" required/>
          </fieldset>

          <fieldset>
            <label class="form-label" for="relation">Car License Plate <span class="form-required"> *</span></label>
            <input id="relation" class="form-input" type="text" name="your-relation" placeholder="Car License Plate" required/>
          </fieldset>
